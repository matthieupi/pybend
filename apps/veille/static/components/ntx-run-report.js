...
class NTXRunReport extends HTMLElement {
    ...
    static styles = `
        ...
        .status-badge.status-complete  { background: var(--success, #4ade80); color: #000; }
        .status-badge.status-running   { background: var(--accent, #4cc9f0); color: #000; }
        .status-badge.status-failed    { background: var(--error, #f87171); color: #fff; }
        .status-badge.status-pending   { background: var(--surface-3, #0f3460); color: var(--text-2, #aaa); }
        ...
        .type-pill.type-full  { background: var(--accent, #4cc9f0); color: #000; }
        .type-pill.type-adhoc { background: var(--warning, #f59e0b); color: #000; }
        ...
        .count-admissible    { background: rgba(74, 222, 128, 0.12); color: var(--success, #4ade80); }
        .count-partial       { background: rgba(245, 158, 11, 0.12); color: var(--warning, #f59e0b); }
        .count-nonadmissible { background: rgba(248, 113, 113, 0.12); color: var(--error, #f87171); }
        .count-new           { background: rgba(255,255,255,0.06); color: var(--text-2, #aaa); }
        ...
        .error-state { color: var(--error, #f87171); }
        ...
        .section-header-admissible    { border-left-color: var(--success, #4ade80); }
        .section-header-partial       { border-left-color: var(--warning, #f59e0b); }
        .section-header-nonadmissible { border-left-color: var(--error, #f87171); }
        .section-header-new           { border-left-color: var(--text-2, #555); }
        ...
        .score-high { background: rgba(74, 222, 128, 0.2); color: var(--success, #4ade80); }
        .score-mid  { background: rgba(245, 158, 11, 0.2); color: var(--warning, #f59e0b); }
        .score-low  { background: rgba(248, 113, 113, 0.2); color: var(--error, #f87171); }
        .score-none { background: var(--surface-3, #0f3460); color: var(--text-2, #aaa); }
        ...
        .grant-card-meta {
            ...
            gap: 0.25rem 0.75rem;
            margin-top: 0.2rem;
            padding-left: calc(0.4rem + 0.4rem + 0.5rem); /* align with title */
        }
        ...
        .grant-reasoning {
            margin-top: 0.25rem;
            padding-left: calc(0.4rem + 0.4rem + 0.5rem);
            font-size: 0.75rem;
