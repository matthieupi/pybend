 ...
 *   3. ntx-table #submitCreate() did not validate number fields —
 ...
 * The table is slotted via ntx-router (light DOM), not inside shadow DOM.
 */
 ...
 * The table is a slotted child of ntx-router, so it's in the light DOM.
 */
