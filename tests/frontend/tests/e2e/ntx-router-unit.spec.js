/**
 * ntx-router — Comprehensive Unit Tests
 *
...
test.describe('ntx-router — Root State (No Hash)', () => {

  test('at root, router shows slot content (ntx-list)', async ({ page }) => {
  ...
  test('ntx-list is visible inside router at root', async ({ page }) => {
    ...
    const listVisible = await page.evaluate(() => {
      const list = document.querySelector('ntx-router ntx-list');
      return !!list;
    });
...
test.describe('ntx-router — Detail Navigation', () => {
  ...
  test('detail item in router uses ref attribute', async ({ page }) => {
    ...
    const ref = await page.locator('ntx-router').evaluate((r) => {
      const item = r.shadowRoot?.querySelector('.router-content ntx-item');
...
test.describe('ntx-router — Back Navigation', () => {
...
test.describe('ntx-router — Hash-Based Routing', () => {
  ...
  test('non-existent product hash handles gracefully (no crash)', async ({ page }) => {
    ...
    const routerOk = await page.locator('ntx-router').evaluate((r) => {
      return !!r.shadowRoot;
    });
...
test.describe('ntx-router — Special Routes', () => {
...
test.describe('ntx-router — History', () => {
...
test.describe('ntx-router — Edge Cases', () => {
