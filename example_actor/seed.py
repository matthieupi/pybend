...
from pybend.example_actor.models import Product, Comment, Like, User, Bot
...
def seed():
    ...
    products = [
        ...
        {"name": "Portable SSD 1TB", "price": 89.99,
         ...
         "image": "https://fastly.picsum.photos/id/201/400/300.jpg?hmac=WuOJnZ-Lbl3VEK89bPH0VjNvZ0wJb_e-K0VKbnGOcMY"},
        {"name": "Webcam 4K", "price": 119.00,
         "description": "4K30 sensor, auto-focus, built-in privacy shutter.",
         "image": "https://fastly.picsum.photos/id/250/400/300.jpg?hmac=7K0Sz-gSJLnxBSYPMFnx_RwY7p9_YqoV4mmLP_4Q2b4"},
        {"name": "Bluetooth Mouse", "price": 34.99,
         "description": "Ergonomic vertical mouse, quiet clicks, 6 buttons.",
         "image": "https://fastly.picsum.photos/id/60/400/300.jpg?hmac=H5if0Gci0LIwBj_4CM0p_93k8PSrHiSlaKQaIDeBnVo"},
        # Home
        {"name": "Smart LED Bulbs (4-pack)", "price": 42.00,
         "description": "WiFi RGBW bulbs, 800 lumens each, voice assistant compatible.",
         "image": "https://fastly.picsum.photos/id/163/400/300.jpg?hmac=IPVNR_VH-0jIUh4RSwqAfGrq-rfjcX40bG07Gy5R_AI"},
        {"name": "Pour-Over Coffee Set", "price": 28.50,
         "description": "Ceramic dripper, glass carafe, 40 paper filters included.",
         "image": "https://fastly.picsum.photos/id/225/400/300.jpg?hmac=SFZ67GzXqVvVmB4RGet9-_IAPmLSsCPU49l3kPjG6Hs"},
        {"name": "Cast Iron Skillet 12\"", "price": 35.00,
         "description": "Pre-seasoned, oven-safe to 500 F, lifetime warranty.",
         "image": "https://fastly.picsum.photos/id/312/400/300.jpg?hmac=P0eWpM-zrPK8WDkK_tbUvz1Bm0xOKfY5OJpyv3e7gxI"},
        {"name": "Bamboo Desk Organizer", "price": 24.99,
         "description": "5-slot organizer for pens, phone, cards. Natural bamboo finish.",
         "image": "https://fastly.picsum.photos/id/180/400/300.jpg?hmac=sc-wsvaIuLYxSoi-c_aAoGmPNOIiQA8VTXIHY0FoyIw"},
        # Outdoor
        {"name": "Hiking Daypack 25L", "price": 64.99,
         "description": "Ripstop nylon, hydration-compatible, rain cover included.",
         "image": "https://fastly.picsum.photos/id/385/400/300.jpg?hmac=56H8pIOyFvDte0mIGb8uzmcSoKl_UX1H_EIH0k7rJCw"},
        {"name": "Titanium Water Bottle", "price": 48.00,
         "description": "750 ml, double-wall insulated, keeps cold 24h / hot 12h.",
         "image": "https://fastly.picsum.photos/id/425/400/300.jpg?hmac=OApFxQS-tkrMbCQm6FuCYzLRp2VKtfjbB_6cjIBgiWo"},
        {"name": "Compact Binoculars", "price": 72.50,
         "description": "10x42 roof prism, multi-coated optics, waterproof.",
         "image": "https://fastly.picsum.photos/id/54/400/300.jpg?hmac=iy0LiBMFHQsCjqQb2S5K89WoiY1hbNh1JoGMySfPiTY"},
        {"name": "Camping Hammock", "price": 32.00,
         "description": "Parachute nylon, supports 400 lbs, tree straps included.",
         "image": "https://fastly.picsum.photos/id/325/400/300.jpg?hmac=S-7cDjjvY-C7Wkj3yAlBYz_B5bH-1LMCHL1t0y4OY4c"},
        # Creative / Misc
        {"name": "Sketchbook A4 (200 pages)", "price": 15.99,
         "description": "Acid-free 120gsm paper, hardcover, lay-flat binding.",
         "image": "https://fastly.picsum.photos/id/169/400/300.jpg?hmac=IM-yTb0dh6CoNO0XfJmkz6-mXJYhpnalZHJwWwz1s_0"},
        {"name": "Wireless Charging Pad", "price": 22.00,
         "description": "15W Qi fast charge, LED indicator, slim profile.",
         "image": "https://fastly.picsum.photos/id/367/400/300.jpg?hmac=IGeF0V0OjXF_fPjOWuVBJ4yB0lJxcQRzJSsjW_TXZSM"},
        {"name": "Noise Machine", "price": 29.95,
         "description": "30 sound profiles, auto-off timer, USB or battery powered.",
         "image": "https://fastly.picsum.photos/id/453/400/300.jpg?hmac=fXppJc3FGXHCD1_TfpBjKqHoES0OGPY2qkJAm2KfbKE"},
        {"name": "Desk Cable Clips (10-pack)", "price": 8.99,
         "description": "Adhesive-backed silicone clips, fits cables up to 7mm.",
         "image": "https://fastly.picsum.photos/id/572/400/300.jpg?hmac=Xb-U3sXvMWg7oJnJ2KZRwNp_sig7iN93hbkl7xJnNFQ"},
    ]
