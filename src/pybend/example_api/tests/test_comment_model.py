...
from pybend.example_api.models import Comment, Like
...
class TestCommentLike:
    ...
    def test_like_join_model_not_registered(self):
        ...
        with patch('pybend.example_api.models.comment.join_models', {}):
            with pytest.raises(MethodError):
    ...
    def test_like_creates_new(self):
        ...
        with patch('pybend.example_api.models.comment.join_models', {('Comment', 'Like'): mock_join}):
