...
def run():
    ...
    with sync_playwright() as p:
        ...
        click_result = page.evaluate("""() => {
            ...
            const product = list.shadowRoot.querySelector('ntt-item');
            if (!product || !product.shadowRoot) return { error: 'no product' };
            const comment = product.shadowRoot.querySelector('ntt-item');
        ...
        page.evaluate("""() => {
            const list = document.querySelector('ntt-list');
            const product = list.shadowRoot.querySelector('ntt-item');
            const method = product.shadowRoot.querySelector('ntt-method[icon="star"]');
