...
Supports incremental seeding at different scale tiers:
    python -m pybend.core.tests.profiling.seed_perf --tier empty      # 0 records
    python -m pybend.core.tests.profiling.seed_perf --tier small      # ~36 records
    python -m pybend.core.tests.profiling.seed_perf --tier medium     # ~197 records
    python -m pybend.core.tests.profiling.seed_perf --tier large      # ~433 records
    python -m pybend.core.tests.profiling.seed_perf --tier full       # ~2000 records
    python -m pybend.core.tests.profiling.seed_perf --reset --tier full
"""
...
logger = logging.getLogger('pybend.seed_perf')
