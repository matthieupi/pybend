# PyBend API Reference

Complete reference for all PyBend classes, methods, and decorators.
...
Base class for all PyBend models. Provides schema generation, validation, and optional storage.
...
Registers a model with PyBend's system.
...
PyBend provides type hints for all public APIs. Use with mypy or pyright for static type checking:
