...
// Import after mocks
await import('../../components/ntt-topbar.js');
const { permissions } = await import('../../utils/Permissions.js');

describe('ntt-topbar.js (NTTTopbar)', () => {
  ...
  describe('custom element registration', () => {
    it('should be registered as ntt-topbar', () => {
      const Ctor = customElements.get('ntt-topbar');
  ...
  describe('constructor', () => {
    it('should create shadow DOM', () => {
      const el = document.createElement('ntt-topbar');
