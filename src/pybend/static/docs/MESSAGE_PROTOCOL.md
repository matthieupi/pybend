...
All communication in NTT happens via TX messages routed through the Actor hierarchy. This document describes every message type, who sends it, who handles it, and what happens.
