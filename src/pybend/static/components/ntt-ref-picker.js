...
export class NTTRefPicker extends HTMLElement {
  ...
  /** Collect current refs from the parent ntt-item to filter duplicates. */
  get currentRefs() {
    const refs = new Set();
    // Walk up to the host (ntt-item shadow root → ntt-item)
...
customElements.define('ntt-ref-picker', NTTRefPicker);
