...
export class NTTRouter extends Component {
    ...
    get styles() { return new URL('./ntt-router.css', import.meta.url).href; }
    ...
    #mountView(routeData) {
        ...
        if (typeof routeData === 'string' && routeData.startsWith('@')) {
            // App route: @profile → <ntt-profile>, @settings → <ntt-settings>
...
customElements.define('ntt-router', NTTRouter);
