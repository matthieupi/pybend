...
test.describe('Product Detail Navigation', () => {
  ...
  test('back button returns to list', async ({ page }) => {
    ...
    // Click back button inside ntt-router
    const router = page.locator('ntt-router');
  ...
  test('router title shows model name', async ({ page }) => {
    ...
    const title = await page.locator('ntt-router').evaluate((r) => {
  ...
  test('back button not visible at root', async ({ page }) => {
    ...
    const hasBackBtn = await page.locator('ntt-router').evaluate((r) => {
