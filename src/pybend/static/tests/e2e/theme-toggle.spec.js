...
test.describe('Theme Toggle', () => {
  ...
  test('default theme is dark', async ({ page }) => {
    ...
    await page.evaluate(() => window.localStorage.removeItem('ntt-theme'));
  ...
  test('theme persists in localStorage', async ({ page }) => {
    await page.goto(APP_URL);
    await page.evaluate(() => window.localStorage.setItem('ntt-theme', 'light'));
    await page.reload({ waitUntil: 'networkidle' });
  ...
  test('theme survives page reload', async ({ page }) => {
    ...
    const storedTheme = await page.evaluate(() =>
      window.localStorage.getItem('ntt-theme')
    );
