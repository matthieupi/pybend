...
import { NTTRefPicker } from '../../components/ntt-ref-picker.js';
import { NTT } from '../../core/NTT.js';
import { Formidable } from '../../generators/form.js';
import TX from '../../core/TX.js';

describe('ntt-ref-picker.js (NTTRefPicker)', () => {
  ...
  describe('custom element registration', () => {
    it('should be registered as ntt-ref-picker', () => {
      expect(customElements.get('ntt-ref-picker')).toBe(NTTRefPicker);
    });
  });
  ...
  describe('attribute getters', () => {
    it('should return field attribute', () => {
      const picker = document.createElement('ntt-ref-picker');
