...
import { NTTMethod } from '../../components/ntt-method.js';

describe('ntt-method.js (NTTMethod)', () => {
  ...
  describe('constructor', () => {
    it('should be registered as ntt-method', () => {
      expect(customElements.get('ntt-method')).toBe(NTTMethod);
    });
