...
// Import after mocks
await import('../../components/ntt-profile.js');

describe('ntt-profile.js (NTTProfile)', () => {
  ...
  describe('custom element registration', () => {
    it('should be registered as ntt-profile', () => {
      const Ctor = customElements.get('ntt-profile');
  ...
  describe('constructor', () => {
    it('should create shadow DOM', () => {
      const el = document.createElement('ntt-profile');
