...
// Import after mocks
await import('../../components/ntt-logs.js');
const Logging = (await import('../../utils/Logging.js')).default;

describe('ntt-logs.js (NTTLogs)', () => {

  describe('custom element registration', () => {
    it('should be registered as ntt-logs', () => {
      expect(customElements.get('ntt-logs')).toBeTruthy();
    });
  });

  describe('constructor', () => {
    it('should create shadow DOM', () => {
      const el = document.createElement('ntt-logs');
