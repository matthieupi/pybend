...
- inject_schemas: add inline <script data-ntx-schema> tags (mode="schema")
...
logger = logging.getLogger('n3tx.ssr')
...
def build_schema_tags(models: dict) -> str:
    ...
    Returns:
        HTML string of <script type="application/json" data-ntx-schema="..."> tags.
    """
    tags = []
