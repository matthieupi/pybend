#!/usr/bin/env python3
"""
Test runner for ALL N3TX tests (unit + integration).

The shims MUST be registered BEFORE pytest starts, because pytest may
discover n3tx/__init__.py during collection (before conftest.py runs).
...
Usage: cd /workspace/src/n3tx/core && python3 run_tests.py [pytest args...]
