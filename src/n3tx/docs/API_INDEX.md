# N3TX API Documentation Index

Complete frontend-focused API documentation for N3TX applications.
...
General conventions, setup, and concepts you need to understand before using any N3TX API.
...
**Who should read this:** Everyone using a N3TX API
...
- [N3TX README](./README.md) - Project overview and setup
