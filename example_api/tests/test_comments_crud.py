...
Routes: /products/{parent_id}/comments/...
"""
...
class TestCreateComment:
    """POST /products/{parent_id}/comments -- create comment."""
...
class TestReadComment:
    """GET /products/{parent_id}/comments/{id} -- read single comment."""
...
class TestListComments:
    """GET /products/{parent_id}/comments -- list comments for product."""
    ...
    def test_list_comments_for_nonexistent_product(self, client):
        resp = client.get("/products/99999/comments")
        data = resp.json()
        items = data if isinstance(data, list) else data.get("data", [])
