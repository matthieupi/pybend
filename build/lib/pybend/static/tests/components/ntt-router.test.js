...
import { NTTRouter } from '../../components/ntt-router.js';

describe('ntt-router.js (NTTRouter)', () => {

  describe('custom element registration', () => {
    it('should be registered as ntt-router', () => {
      expect(customElements.get('ntt-router')).toBe(NTTRouter);
    });
  });

  describe('constructor', () => {
    it('should create element with shadow DOM', () => {
      const el = document.createElement('ntt-router');
