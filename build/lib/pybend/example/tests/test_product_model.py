...
from pybend.example.models import Product, Comment, Like
...
class TestProductFavorite:
    ...
    def test_favorite_join_model_not_registered(self):
        ...
        with patch('pybend.example.models.product.join_models', {}):
    ...
    def test_favorite_creates_new(self):
        ...
        with patch('pybend.example.models.product.join_models', {('Product', 'Like'): mock_join}):
