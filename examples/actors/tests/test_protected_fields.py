...
class TestProtectedFieldsInSchema:
    ...
    Comment and Like are registered as join models (ProductComment, CommentLike).
    """

    def test_comment_user_owner_marked_protected(self, client):
        """ProductComment schema has user_owner with ui.protected=true."""
    ...
    def test_like_user_marked_protected(self, client):
        """CommentLike schema has user with ui.protected=true."""
    ...
    def test_product_defs_like_user_protected(self, client):
        ...
        inline reference. The authoritative schema is on /CommentLike."""
        schema = client.get("/CommentLike").json()
